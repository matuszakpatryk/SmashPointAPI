...
protocol AppError: AbortError {}

enum ListError: AppError {
    case noListFoundForGivenUser
    case listNameAlreadyExists
}

extension ListError: AbortError  {
...
enum ProductError: AppError {
    case noProductFoundForGivenUser
    case productNameAlreadyExist
    case userCannotBeEmpty
}
...
extension ProductError: AbortError  {
    var status: HTTPResponseStatus {
        ...
        case .productNameAlreadyExist:
            return HTTPResponseStatus.badRequest
        case .userCannotBeEmpty:
            return HTTPResponseStatus.preconditionFailed
        }
    }
}
